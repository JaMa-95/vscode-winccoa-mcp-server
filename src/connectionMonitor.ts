...
export class ConnectionMonitor {
    ...
    start(): void {
        ...
        ExtensionOutputChannel.info(`Connection Monitor: Starting (interval: ${this.config.heartbeatInterval}ms)`);
    ...
    updateConfig(config: Partial<ConnectionMonitorConfig>): void {
        ...
        ExtensionOutputChannel.debug(`Connection Monitor: Config updated - ${JSON.stringify(this.config)}`);
    ...
    private async checkConnection(): Promise<void> {
        ...
        try {
            ...
            if (isConnected) {
                ...
                // Connection lost
                ExtensionOutputChannel.warn('Connection Monitor: ❌ Heartbeat failed - connection lost');
